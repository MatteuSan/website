    ...
    <DefaultLayout title="HOME" heroTitle="MatteuSan"
      ...
      <section className="grid about-me" id="about-me">
        ...
        <HCCard title="Projects" icon="dashboard"
                description="If you are interested in taking a look on what I've been working on lately, click the button below."
        ...
        <HCCard title="Open Source" icon="public"
                description="I absolutely love doing open source projects! You can check out and use UI/UX tools I've been developing and open-sourcing the past few months by clicking the button below.">
          <HCButton type="filled" link="#tools">Open Source Tools</HCButton>
        </HCCard>

        <HCCard title="Ready to collaborate?" icon="phone"
                description="I'd also be delighted to work on your project! Just click the contact button below and we'll keep in touch :)">
