    ...
    <DefaultLayout title="HOME" heroTitle="MatteuSan"
      ...
      <div id="skills-and-technologies">
        ...
        <div className="content">
          ...
          <p>When embarking on projects, I prioritize selecting technologies tailored to address specific challenges. Yet, certain technologies hold a special place in my toolkit--they're the ones I trust. Whether it's UI/UX engineering, frontend development, or design, I choose tools based on their capacity to deliver optimal solutions. While flexibility is key, these trusted technologies are the cornerstone of my approach, ensuring reliability and efficiency in every project endeavor.</p>
        </div>
      </div>
      ...
      <section id="ready-to-collaborate">
        ...
        <p style={ { margin: '1rem 0' } }>I'd be delighted to work on your project! Just click any of the contact
          buttons
          below and we'll keep in touch
          :)</p>
        <div style={{ display: 'flex', flexFlow: 'row wrap', gap: '0.5rem', justifyContent: 'center', margin: '0.7rem 0 0' }}>
          <HCButton type="filled" icon={['left', 'email']} link="mailto:matteugt@gmail.com" isDisabled>Email</HCButton>
